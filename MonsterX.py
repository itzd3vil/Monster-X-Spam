...
async def start_hero():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@TheClubHouse_xD"))
            await idk(functions.channels.JoinChannelRequest(channel="@TheClubHouse_xD"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@TheClubHouse_xD"))
            await ydk(functions.channels.JoinChannelRequest(channel="@TheClubHouse_xD"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@TheClubHouse_xD"))
            await wdk(functions.channels.JoinChannelRequest(channel="@TheClubHouse_xD"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@TheClubHouse_xD"))
            await hdk(functions.channels.JoinChannelRequest(channel="@TheClubHouse_xD"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@TheClubHouse_xD"))
            await sdk(functions.channels.JoinChannelRequest(channel="@TheClubHouse_xD"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@TheClubHouse_xD"))
            await adk(functions.channels.JoinChannelRequest(channel="@TheClubHouse_xD"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@TheClubHouse_xD"))
            await bdk(functions.channels.JoinChannelRequest(channel="@TheClubHouse_xD"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@TheClubHouse_xD"))
            await cdk(functions.channels.JoinChannelRequest(channel="@TheClubHouse_xD"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@TheClubHouse_xD"))
            await ddk(functions.channels.JoinChannelRequest(channel="@TheClubHouse_xD"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@TheClubHouse_xD"))
            await edk(functions.channels.JoinChannelRequest(channel="@TheClubHouse_xD"))
...
loop.run_until_complete(start_hero())       
...
async def spam(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        herosexy = hero[1:]
        if len(herosexy) == 2:
            message = str(herosexy[1])
            counter = int(herosexy[0])
            sleeptime = float(hero[0])
            for _ in range(counter):
...
async def ping(e):
    if e.sender_id in SMEX_USERS:
        ...
        await event.edit(f"🤖 𝗣𝗼𝗻𝗴!\n`{ms}` 𝗺𝘀\nMonsterX SpamBot By @Monster_x_Hunter")
...
async def help(e):
    if e.sender_id in SMEX_USERS:
       text = "𝗔𝘃𝗮𝗶𝗹𝗮𝗯𝗹𝗲 𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀\n\n𝙐𝙩𝙞𝙡𝙨 𝘾𝙤𝙢𝙢𝙖𝙣𝙙:\n.ping\n.restart\n\n𝙐𝙨𝙚𝙧𝙗𝙤𝙩 𝘾𝙤𝙢𝙢𝙖𝙣𝙙:\n.bio\n.join\n.pjoin\n.leave\n\n𝙎𝙥𝙖𝙢 𝘾𝙤𝙢𝙢𝙖𝙣𝙙:\n.spam\n.delayspam\n.bigspam\n.raid\n.replyraid\n.dreplyraid\n\n\nPowerful SpamBot By @Monster_X_Hunter"
       await e.reply(text, parse_mode=None, link_preview=None )
...
print(text)
print("")
print("SMEX! hero Multi Spam Bot Started Sucessfully.")
